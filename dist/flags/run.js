...
function () {
  ...
  regeneratorRuntime.mark(function _callee(command) {
    var _ref2, scriptName, customFlags, inputPrompts, _i, _inputPrompts, promptOptions, createFlag, options, _ref3, result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 19:
            ...
            return _context.abrupt("return", "".concat(command, " ").concat(customFlags.join(' '), " ").concat(scriptName));

          case 21:
            return _context.abrupt("return", "".concat(command, " ").concat(scriptName));
